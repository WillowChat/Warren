...
class MonitorOnlineHandlerTests {
    ...
    @Test fun test_handle_NoTargets_FiresNoEvents() {
        sut.handle(RplMonOnlineMessage(Prefix(nick = "me"), nickOrStar = "*", targets = listOf()), tags = mapOf())
    ...
    @Test fun test_handle_WithTargets_FiresEventForEachUser() {
        ...
        sut.handle(RplMonOnlineMessage(Prefix(nick = "me"), nickOrStar = "*", targets = targets), tags = mapOf())
