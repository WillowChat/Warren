...
class Rpl473HandlerTests {
    ...
    @Test fun test_handle_NonexistentChannel_DoesNothing() {
        handler.handle(Rpl473Message(source = "", target = "", channel = "#somewhere", contents = ""), TagStore())
    ...
    @Test fun test_handle_ValidChannel_SetsStatusToFailed() {
        ...
        handler.handle(Rpl473Message(source = "", target = "", channel = "#channel", contents = ""), TagStore())
