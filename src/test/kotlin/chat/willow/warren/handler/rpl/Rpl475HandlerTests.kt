...
class Rpl475HandlerTests {
    ...
    @Test fun test_handle_NonexistentChannel_DoesNothing() {
        handler.handle(Rpl475Message(source = "", target = "", channel = "#somewhere", contents = ""), TagStore())
    ...
    @Test fun test_handle_ValidChannel_SetsStatusToFailed() {
        ...
        handler.handle(Rpl475Message(source = "", target = "", channel = "#channel", contents = ""), TagStore())
