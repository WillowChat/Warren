...
class Rpl474HandlerTests {
    ...
    @Test fun test_handle_NonexistentChannel_DoesNothing() {
        handler.handle(Rpl474MessageType(source = "", target = "", channel = "#somewhere", content = ""), TagStore())
    ...
    @Test fun test_handle_ValidChannel_SetsStatusToFailed() {
        ...
        handler.handle(Rpl474MessageType(source = "", target = "", channel = "#channel", content = ""), TagStore())
