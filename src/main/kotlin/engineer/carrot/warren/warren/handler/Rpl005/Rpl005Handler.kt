...
class Rpl005Handler(val state: ParsingState, val prefixHandler: IRpl005PrefixHandler, val channelModesHandler: IRpl005ChanModesHandler) : IKaleHandler<Rpl005Message> {
